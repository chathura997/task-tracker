...
public class TaskService {
    ...
    public Page<TaskResponse> getTasks(TaskStatus status, UUID ownerIdFilter, Pageable pageable, Authentication auth) {
        User currentUser = getCurrentUser(auth);
    ...
    private TaskStatus parseStatus(String status) {
        try {
            ...
            throw new IllegalArgumentException("Invalid status: " + status + ". Must be one of TODO, IN_PROGRESS, DONE");
        }
    }
